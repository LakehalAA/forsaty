                ...
                <div className="container relative">
                    <div className="grid lg:grid-cols-12 mt-10 md:grid-cols-2 gap-[30px] items-center">
                        <div className="lg:col-span-7">
                            <h4 className="text-white lg:text-[40px] text-4xl lg:leading-normal leading-normal font-medium mb-7 position-relative font-Arial">Bluid your audiance <br /> and sale more</h4>
                        ...
                        <div className="lg:col-span-5">
                            <div className="bg-white dark:bg-slate-900 rounded-xl shadow md:p-10 p-6 lg:ms-10 z-10 relative">
                                <h4 className="mb-5 font-medium text-2xl dark:text-white font-Arial">We are offering to you <br /> 14 days free trial</h4>
