                ...
                <div className="container flex flex-wrap items-center justify-end">
                    <a className="navbar-brand md:me-8" href="/">
                        <span className="inline-block dark:hidden">
                            <img src="/images/logo-dark.png" className="l-dark" alt="" width={113} height={28}/>
                            <img src="/images/logo-light.png" className="l-light" alt="" width={113} height={28}/>
                        </span>
                        <img src="/images/logo-light.png" className="hidden dark:inline-block" alt="" width={113} height={28}/>
                    </a>
                    ...
                    <div className="nav-icons flex items-center lg_992:order-2 ms-auto lg:ms-4">
                        ...
                        <ul className="list-none menu-social mb-0">
                            <li className="inline">
                                <Link href="https://www.forsaty.org/login" 
