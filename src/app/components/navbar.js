            ...
            <nav className={`${navbarTop === true ? 'is-sticky' : ''} navbar font-Arial `} id="navbar">
                ...
                <a className="navbar-brand md:me-8" href="/">
                        <span className="inline-block dark:hidden">
                            <Image src="/images/logo-dark copy.png" className="l-dark" alt="" width={113} height={28}/>
                            <Image src="/images/logo-light copy.png" className="l-light" alt="" width={113} height={28}/>
                        </span>
                    ...
                    <div className={`${isOpen === true ? 'navigation lg_992:order-1 lg_992:flex hidden ms-auto ' : 'navigation lg_992:order-1 lg_992:flex ms-auto block'}`} id="menu-collapse">
                        ...
                        <ul className="navbar-nav nav-light sidebar-nav" id="navbar-navlist">
                            ...
                            <li className={`nav-item navbar-item ${pathname === '/projets' ? 'active' : ''}`}>
                                 <Link href="/projets" className="nav-link">Projets</Link>
                            </li>
                            <li className={`nav-item navbar-item ${pathname === '/contactus' ? 'active' : ''}`}>
                                 <Link href="/contactus" className="nav-link">Contactez nous</Link>
                            </li>
                        </ul>
