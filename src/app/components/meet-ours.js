        ...
        <>
            <div className="container lg:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    <h3 className="mb-4 md:text-2xl text-xl font-medium font-Arial">Notre Équipe, Votre Force</h3>
                    <p className="text-slate-400 max-w-xl mx-auto">Découvrez notre équipe passionnée, unie pour propulser votre succès financier avec expertise et dévouement.</p>
                </div>
                        ...
                        <div className="lg:col-span-3 md:col-span-6" key={index} >
                            <div className="group text-center">
                                ...
                                <div className="content mt-3">
                                     <Link href=""
                                        className="text-lg hover:text-violet-600 transition-all duration-500 ease-in-out h5 font-Arial">{item.title}</Link>
