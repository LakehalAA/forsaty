            ...
            <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="testi">
                <div className="container">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        <h3 className="mb-6 md:text-2xl text-xl font-medium font-Arial">Voix de la Confiance</h3>

                        <p className="text-slate-400 max-w-xl mx-auto">Découvrez ce que nos partenaires disent de leur expérience avec Forsaty. Des témoignages authentiques qui illustrent notre engagement envers la transparence, la confiance et le succès partagé!</p>
                    </div>
                            ...
                            return(
                                ...
                                <li className="rounded-lg shadow-lg dark:shadow-gray-800 p-6 bg-white dark:bg-slate-900">
                                    <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        ...
                                        <div className="ps-4">
                                             <Link href="" className="text-lg h5 hover:text-violet-600 duration-500 ease-in-out font-Arial">{item.name}</Link>
                                ...
                                <li className="rounded-lg shadow-lg dark:shadow-gray-800 p-6 bg-white dark:bg-slate-900">
                                    <div className="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        ...
                                        <div className="ps-4">
                                             <Link href="" className="text-lg h5 hover:text-violet-600 duration-500 ease-in-out font-Arial">{item.name1}</Link>
