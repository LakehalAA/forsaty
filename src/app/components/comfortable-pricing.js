        ...
        <>
            <section className="relative md:py-24 py-16" id="pricing">
                <div className="container">
                    {title || desc ? <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <div className="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px] items-center">
                        <div className="shadow rounded-md p-6 bg-gradient-to-t bg-violet-600">
                            <div className="pb-8">
                                <h3 className="mb-6 text-xl font-medium text-white font-Arial">Business</h3>
                                <div className="mb-6 text-white/50 font-Arial">
                                ...
                                <Link href=""
                                    className="py-2 px-5 inline-block font-normal tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-orange-600 hover:bg-orange-700 border-orange-600 hover:border-orange-700 text-white rounded-md w-full">Started
                                    Now</Link>
                            </div>
                            ...
                            <ul className="self-start pt-8">
                                <li className="flex items-center mb-1 text-white/80">
                                   <Unicons.UilCheckCircle width={16} className="text-orange-600 me-2"/>
                        ...
                        <div className="p-6">
                            <div className="pb-8">
                                <h3 className="mb-6 text-xl font-medium dark:text-white font-Arial">Free</h3>
                                <div className="mb-6 dark:text-white/50 font-Arial">
                                    <span className="relative h6 -top-5 text-xl">$</span>
                                ...
                                <Link href=""
                                    className="py-2 px-5 inline-block font-normal tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-violet-600/5 hover:bg-violet-600 border-violet-600/10 hover:border-violet-600 text-violet-600 hover:text-white rounded-md w-full">Redeem
                                    Now</Link>
                            </div>
                            <div className="border-b border-slate-200 dark:border-slate-200/5"></div>
                            <ul className="self-start pt-8">
                                <li className="flex items-center mb-1 text-slate-400">
                                     <Unicons.UilCheckCircle width={16} className="text-green-600 me-2"/>
                                    <span>Complete documentation</span>
                                </li>
                        ...
                        <div className="p-6">
                            <div className="pb-8">
                                <h3 className="mb-6 text-xl font-medium dark:text-white font-Arial">Corporate</h3>
                                <div className="mb-6 dark:text-white/50 font-Arial">
                                    <span className="relative h6 -top-5 text-xl">$</span>
                                ...
                                <Link href=""
                                    className="py-2 px-5 inline-block font-normal tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-md w-full">Signup
                                    Now</Link>
                            </div>
                            <div className="border-b border-slate-200 dark:border-slate-200/5"></div>
                            <ul className="self-start pt-8">
