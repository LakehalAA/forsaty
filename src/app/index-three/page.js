            ...
            <section className="py-36 md:h-auto md:py-0 flex items-center relative bg-violet-600/10 dark:bg-violet-600/40" id="home">
                <div className="container relative z-2">
                    <div className="grid grid-cols-1 text-center mt-0 md:mt-12 pt-0 md:pt-12">
                        <div className="mt-28">
                            <div>
                                <h4 className="lg:text-[40px] text-4xl lg:leading-normal leading-normal font-medium mb-7 position-relative dark:text-white font-Arial">Start Creating Beautiful Landing <br /> Pages Today!</h4>
